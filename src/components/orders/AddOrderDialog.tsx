      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            ...
            <Input id="items" value={items} onChange={e => setItems(e.target.value)} placeholder="Enter items" />
          </div>
          <div className="grid gap-2">
          ...
          <div className="grid gap-2">
            ...
            <Input id="customerEmail" value={customerEmail} onChange={e => setCustomerEmail(e.target.value)} type="email" placeholder="Enter customer email" />
          </div>
          <div className="grid gap-2">
            <Label htmlFor="value">Order Value</Label>
            <Input id="value" value={value} onChange={e => setValue(e.target.value)} placeholder="Enter order value" />
          </div>
          <div className="grid gap-2">
