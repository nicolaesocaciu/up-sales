...
export const ConnectStore = ({
  ...
  return <div className="flex-1">
      ...
      <div className="flex items-center bg-blue-50 p-4 rounded-lg max-w-lg">
        ...
        <Input value={storeUrl} onChange={e => setStoreUrl(e.target.value)} placeholder="websitename" className="rounded-l-none border-l-0" />
        <Button onClick={handleConnect} className="ml-4">
          Connect
        </Button>
      </div>
    </div>;
