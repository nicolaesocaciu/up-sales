...
export const ModuleCard = ({
  ...
  return <div className={`
        ...
        ${selected 
          ? 'border-[#1482CC] border-4 bg-[#E7F2F9]' 
          : 'border-gray-200 bg-white hover:border-gray-300 shadow-[0px_5px_10px_0px_rgba(27,56,76,0.1)]'}
      `} onClick={onClick}>
      <div className="flex-1 flex items-center justify-center mb-4">
        {selected ? (
          <div className="bg-[#1482CC] rounded-full w-16 h-16 flex items-center justify-center">
          ...
          <div className="bg-[#E7F2F9] w-16 h-16 rounded-[16px]"></div>
        )}
      </div>
