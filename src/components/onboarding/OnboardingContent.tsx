...
export const OnboardingContent = ({
  ...
  return <div className="h-full p-12 flex flex-col px-[128px] py-[96px] relative">
      {renderStepContent()}
      
      {shouldShowFooter && <div className="fixed bottom-0 right-0 bg-white py-[24px] px-[128px] border-t border-[#DADADA] flex justify-between w-[1080px]">
