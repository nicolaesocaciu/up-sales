...
export const ProductsAndAdsSection = ({
  isEditMode
}: ProductsAndAdsSectionProps) => {
  return <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 h-full group relative bg-white rounded-[24px]">
        {isEditMode && <div className="absolute left-6 top-6 cursor-grab active:cursor-grabbing z-10">
