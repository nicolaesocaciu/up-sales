...
export interface ColumnVisibility {
  ...
  lastUpdated: boolean;
  openRate: boolean;
  subscribedRate: boolean;
  activeRate: boolean;
  actions: boolean;
}

interface MarketingCampaignsTableColumnsProps {
  columnVisibility: ColumnVisibility;
  onColumnVisibilityChange: (visibility: ColumnVisibility) => void;
}

export const MarketingCampaignsTableColumns = ({
  columnVisibility,
  onColumnVisibilityChange,
}: MarketingCampaignsTableColumnsProps) => {
              ...
              >
                ...
                <span className="text-sm">
                  {key === 'lastUpdated' ? 'Last Updated' : 
                   ...
                   key === 'subscribedRate' ? 'Subscribed' :
                   key === 'activeRate' ? 'Active on Site' :
