    ...
    <TableHeader className="bg-[#F2F2F2] rounded-[8px]">
      <TableRow className="hover:bg-transparent border-none h-12">
        ...
        {columnVisibility.subscribedRate && (
          <TableHead
            onClick={() => onSortChange('subscribedRate')}
            className="cursor-pointer hover:bg-[#DADADA]"
          >
            <div className="flex items-center gap-2">
        ...
        {columnVisibility.activeRate && (
          <TableHead
            onClick={() => onSortChange('activeRate')}
            className="cursor-pointer hover:bg-[#DADADA]"
          >
            <div className="flex items-center gap-2">
        ...
        {columnVisibility.actions && (
          <TableHead className="rounded-r-[8px] w-[50px] text-right">Actions</TableHead>
        )}
      </TableRow>
    </TableHeader>
  );
