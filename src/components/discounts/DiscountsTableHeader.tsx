...
interface DiscountsTableHeaderProps {
...
export const DiscountsTableHeader = ({
  sortDirection,
  onSortChange,
  columnVisibility,
  selectedRows,
  ...
  return (
    <TableHeader className="bg-[#F2F2F2] rounded-[8px]">
      <TableRow className="hover:bg-transparent border-none h-12">
        ...
        {columnVisibility.combinations && <TableHead>Combinations</TableHead>}
        {columnVisibility.used && <TableHead className="text-right cursor-pointer hover:bg-[#DADADA]" onClick={onSortChange}>
